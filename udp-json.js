...
if (this.temperatureOff != "") { this.temperatureService
 }
if (this.humidityOff != "") { this.humidityService
}
if (this.carbonDioxideOff != "") { this.carbondioxideService
}
if (this.lightOff != "") { this.lightService
}
	  return services;
